...
<form action="/home" method="post">
        ...
        <p><input type="text" size="50" name="USERNAME" placeholder="Your name (length:3-20)" required></p>
        <p><input type="text" size="50" name="ADRESS" placeholder="Your email" required></p>
